...
public class RegisterEndpoint : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapPost("/register",
            ...
            {
                var response = await sender.Send(new RegisterCommand(request.Name, request.Email, request.Password, request.PreferredUsername, request.GivenName, request.FamilyName, context));
...
public sealed class RegisterCommandHandler : IRequestHandler<RegisterCommand, RegisterResponse>
{
    ...
    public RegisterCommandHandler(DatabaseContext databaseContext, IPasswordHasher passwordHasher, IJwtProvider jwtProvider)
    {
